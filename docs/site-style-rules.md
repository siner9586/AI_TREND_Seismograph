...
- 站点中文名称统一为：AI 趋势脉冲。
- 站点可保留英文工程名 `AI Trend Seismograph` 用于仓库名、脚注或历史兼容，但面向用户的中文页面不得再使用“AI 趋势地震仪”。
- 导航、页面 title、首页 h1、归档页、日报页、趋势详情页、GitHub 页、机构页、数据源页、Watchlist 页统一使用“AI 趋势脉冲”。
...
- 每次修改后应检查页面中是否残留“地震仪”一词；如是面向用户页面，应替换为“脉冲”。
